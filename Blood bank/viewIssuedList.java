...
public class viewIssuedList extends JFrame{
	...
	public viewIssuedList(){
        ...
        issuedlistLabel.setBackground(new Color(0,0,0));
		...
		greenPanelLayout.setHorizontalGroup(
			...
			.addGroup(greenPanelLayout.createSequentialGroup()
				...
				.addGap(10,10,10)
				.addComponent(bloodcompCombo,GroupLayout.PREFERRED_SIZE,99,GroupLayout.PREFERRED_SIZE)
				.addGap(30,30,30)
	...
	private String[] columnNames={
		"Acceptor's NIC", "Patient name", "Patient's blood group","Blood Bag ID","Required blood group", "RH Factor", "Blood Component", "Issued Date", "Qty","Mobile"
	};
